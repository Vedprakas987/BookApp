...
export default function Bookcard({image,auther,title,IBSN,Year_of_publication}) {
  return (
    <Box  _hover={{border:"0.4px solid #CCCCFF"}} h={"90%"} fontStyle={"oblique"}  borderRadius={"15px"} bg={"#F8F8FF"} fontSize={"15px"} p={"20px"} textAlign={"start"}  boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"}>
<Image m={"auto"}  w={"100%"} h={"70%"} src={image} alt = "prof"/>
<Text noOfLines={[1,2]}  mt={"4px"}   fontSize={{base:"17px",sm:"20px",lg:"17px",xl:"16px","2xl":"16px",md:"17px"}} color={"#1F618D"}>{title}</Text>
